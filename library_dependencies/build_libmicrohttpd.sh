...
download_if_needed() {
    ...
    if [ ! -e libmicrohttpd-$LIB_VERSION ]; then
        wget https://ftp.gnu.org/gnu/libmicrohttpd/libmicrohttpd-$LIB_VERSION.tar.gz
        tar -xzf libmicrohttpd-$LIB_VERSION.tar.gz
    fi
}
